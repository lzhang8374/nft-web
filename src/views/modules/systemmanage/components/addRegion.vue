<template>
	<div>
		<div class="addRegion-form-first">
        ...
        <el-row>
          ...
          <el-form-item label="区域编码:" prop="regionCode">
          	<el-input placeholder="请输入区域编码" v-model="form.regionCode"></el-input>
          </el-form-item>
        </el-row>
        <el-row>
				...
				this.$refs.forms.validate((valid) => {
					if (valid) {
						this.$confirm('确认提交?', '提示', {
							...
							this.$http.post('/api/sysregioninfo/addRegion', this.form).then(res => {
								if (res.data.code != 0) {
