<template>
	<div>
		<div class="editUser-form-first">
			<el-form ref="form" :model="form" :rules="rules" label-width="150px">
				<el-row>
					<el-col :span="12">
						<el-form-item label="用户工号:" prop="username" :maxlength="10" :minlength="0">
							<el-input v-model="form.username" clearable placeholder="请输入用户工号" disabled></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
          ...
          <el-col :span="12">
          	<el-form-item label="用户状态:">
          		<el-select v-model="form.status" placeholder="请选择生效状态" clearable>
          			<el-option
				...
				this.$refs.form.validate((valid) => {
					if(valid){
						this.$confirm('确认修改?', '提示', {
							...
							this.$http.post('/api/sysuser/editUser',this.form).then(res=>{
								if(res.data.code != 0){
