<template>
	<div>
		<div class="editParam-form-first">
			<el-form ref='forms' :model='form' :rules='rules' :inline="true" label-width="120px">
				...
				<el-row>
					<el-form-item label="备注:">
						<el-input style="width:200px;" type="textarea" :rows="2" v-model="form.remark"></el-input>
					</el-form-item>
				</el-row>
			</el-form>
		</div>
		<div class='editParam-footer'>
				...
				this.$refs.forms.validate((valid) => {
					if (valid) {
						this.$confirm('确认提交?', '提示', {
							...
							this.$http.post('param/param/saveParam', this.form).then(res => {
								if (res.data.code != 0) {
